...
api.add_resource(resources.OrganizersFestivals, '/organizers/festivals')
...
api.add_resource(resources.FestivalRevoke, '/festival/<string:festival_id>/revoke')
...
api.add_resource(resources.EventsComplete, '/events/complete')
api.add_resource(resources.EventsPending, '/events/pending')
api.add_resource(resources.EventsActive, '/events/active')
api.add_resource(resources.OnAuction, '/on_auction')
...
api.add_resource(resources.OneJob, '/jobs/<string:job_id>')
api.add_resource(resources.JobsForEvent, '/jobs/event')
api.add_resource(resources.JobsNotOnAuction, '/jobs/auction-off')
api.add_resource(resources.Auction, '/auction')
api.add_resource(resources.Auctions, '/auctions')
api.add_resource(resources.FestivalsComplete, '/festivals/complete')
api.add_resource(resources.FestivalsActive, '/festivals/active')
api.add_resource(resources.FestivalsPending, '/festivals/pending')
api.add_resource(resources.FestivalOrganizersResource, '/festivals/<string:festival_id>')
