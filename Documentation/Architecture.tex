...
\pagebreak
		...
		\section{Class Diagrams}
			...
			\begin{figure}[H]
				\includegraphics[width=\linewidth]{diagrams/UML_model_v1.png}
				\caption{UML Model Class Diagram}
				\label{fig:uml_model_diag}
			\end{figure}
		
			\begin{figure}[H]
				\includegraphics[width=\linewidth]{diagrams/UML_connectors_v1.png}
				\caption{UML Connector Diagram}
				\label{fig:uml_connector_diag}
			\end{figure}
		
			\begin{figure}[H]
				\includegraphics[width=\linewidth]{diagrams/UML_activity_v1.png}
				\caption{UML Activity Diagram}
				\label{fig:uml_activity_diag}
			\end{figure}
