\chapter{Software Specification}
	...
	\section{Functional Requirements}
			...
			\noindent \underbar{\textbf{UC50 - View the list own Events}}
			\begin{packed_item}
				\item \textbf{Main Stakeholders:} Organizer
			...
			\noindent \underbar{\textbf{UC51 - Create Job}}
			\begin{packed_item}
				\item \textbf{Main Stakeholders:} Organizer
			...
			\noindent \underbar{\textbf{UC52 - Apply for a Festival}}
			\begin{packed_item}
				\item \textbf{Main Stakeholders:} Organizer
			...
			\noindent \underbar{\textbf{UC28 - View Job Applications}}
			\begin{packed_item}
				\item \textbf{Main Stakeholders:} Worker
			...
			\noindent \underbar{\textbf{UC53 - Search Users}}
			\begin{packed_item}
