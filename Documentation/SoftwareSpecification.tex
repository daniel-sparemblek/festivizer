\chapter{Software Specification}
	...
	\section{Functional Requirements}
			...
			\noindent \underbar{\textbf{UC48 - Bind an Event to an Organizer}}
			\begin{packed_item}
				\item \textbf{Main Stakeholders:} Leader
			...
			\noindent \underbar{\textbf{UC49 - Open a Job to Auctioning}}
			\begin{packed_item}
				\item \textbf{Main Stakeholders:} Leader
				\item \textbf{Goal:} Add a new Event to this
				\item \textbf{Stakeholders: } Database, Leader, Organizers
			...
			\noindent \underbar{\textbf{UC28 - View Worker Job Application Entries}}
			\begin{packed_item}
				...
				\begin{packed_enum}
					...
					\item[] \begin{packed_enum}
						...
						\item Completed
					\end{packed_enum}
					\item There Jobs can be either verified or declined entry into the Job Auction process
				\end{packed_enum}
			...
			\begin{packed_item}
				\item \textbf{Main Stakeholders:} Leader, Organiser
				\item \textbf{Goal:} Upon inspection, if the Job Entry is deemed quality, verify this Entry so that it can compete with other Entries in the Job Auction
				...
				\item \textbf{Event flow description: }
				\begin{packed_enum}
					\item Upon tapping the verify button, the Job is added to the Job Auction process
					\item Data is sent to the Server
				\end{packed_enum}
