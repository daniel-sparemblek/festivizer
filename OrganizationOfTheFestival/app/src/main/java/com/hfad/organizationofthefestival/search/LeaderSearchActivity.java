...
public class LeaderSearchActivity extends AppCompatActivity {
    ...
    private LeaderSearchController searchController;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        lvSearchResults.setOnItemClickListener((parent, view, position, id) -> {
            Intent intent1 = new Intent(LeaderSearchActivity.this, DefaultUserActivity.class);
