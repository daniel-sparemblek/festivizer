...
public class ApplicationAdapter extends ArrayAdapter<ApplicationResponse> {

    private Context context;
    private int resource;
    private List<ApplicationResponse> applicationList;

    public ApplicationAdapter(Context context, int resource, List<ApplicationResponse> applicationList) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (view == null) {
            view = LayoutInflater.from(context).inflate(R.layout.application_row_layout, null);
        }
