from sqlalchemy import Column, Integer, String, Boolean, DateTime, Float, ForeignKey, UniqueConstraint, ForeignKeyConstraint
...
class FestivalOrganizers(Base):
    ...
    status = Column(Integer) #-2 when first created and not applied for festivals, -1 when waiting on Leader, 0 when rejected and 1 when accepted
